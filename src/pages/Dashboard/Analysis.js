...
class Analysis extends Component {
  ...
  render() {
    ...
    const dataMotor = [{x: "DC1", y: 342}, {x: "DC2", y: 614}, {x: "DC3", y: 762}, {x: "DC4", y: 915}, {x: "DC5", y: 262}]
    const dataMotorSort = dataMotor.sort();
                  ...
                  <Col xl={8} lg={12} md={12} sm={24} xs={24}>
                    <div className={styles.salesRank}>
                      ...
                      <ul className={styles.rankingList}>
                        {dataMotorSort.map((item) => (
                          <li key={item.x}>
                            <span>{item.x}</span>
                            <span> : {numeral(item.y).format('0,0')} Giờ </span>
                          </li>
                        ))}
                      </ul>
                    </div>
