export default {
  'navbar.lang': 'Việt Nam',
  'menu.home': 'Home',
  'menu.dashboard': 'Thống kê',
  ...
  'menu.control': 'Giám sát và Điều khiển',
  'menu.setting.motor': 'Động cơ',
  'menu.control.motor': 'Động cơ',
  ...
  'menu.profile': 'Thông tin Phần mềm',
  ...
  'app.analysis.test': ' DC ',
  'app.analysis.introduce': 'Introduce',
  'app.analysis.total-sales': 'Tổng Hợp',
  'app.analysis.day-sales': 'Số lượng Động cơ hoạt động',
  'app.analysis.visits': 'Thới gian Hoạt động',
  'app.analysis.visits-trend': 'Thời gian( Giờ)',
  'app.analysis.visits-ranking': 'Xếp hạng  theo thời gian',
  'app.analysis.day-visits': 'Day Visits',
  'app.analysis.week': 'tuần trước',
  'app.analysis.day': 'Ngày hôm qua',
  'app.analysis.area1': 'Khu tôm giống',
  'app.analysis.area2': 'Khu tôm Hùm 1',
  'app.analysis.area3': 'Khu tôm Hùm 2 ',
  'app.analysis.conversion-rate': 'Số lượng Động cơ',
  ...
  'app.analysis.all-year': 'Năm',
  'app.analysis.all-month': 'Tháng',
  'app.analysis.all-week': 'Tuần ',
  'app.analysis.all-day': 'Ngày',
